...
export class ConversationClientsController {
    constructor(
        private readonly conversationClientsService: ConversationClientsService,
    ) {}

    @Post()
    create(@Body() createConversationClientDto: CreateConversationClientDto) {
        return this.conversationClientsService.create(
            createConversationClientDto,
        );
    }
    ...
    update(
        @Param('id') id: string,
        @Body() updateConversationClientDto: UpdateConversationClientDto,
    ) {
        return this.conversationClientsService.update(
            +id,
            updateConversationClientDto,
        );
    }
